...
UE.I18N['zh_Hant'] = {
    'labelMap':{
        ...
        'mergecells':'合並多個單元格', 'deletetable':'刪除表格', 'cleardoc':'清空文檔','insertparagraphbeforetable':"表格前插入行",'fontfamily':'字體', 'fontsize':'字號', 'paragraph':'段落格式', 'insertimage':'圖片',
    ...
    'snapscreen':{
        'static':{
            ...
            lang_step2:"第二不，插件安裝完成後即可使用，如不生效，請重啓浏覽器後再試！"
        }
    },
    'insertvideo':{
        'static':{
